...
public abstract class CameraActivity extends AppCompatActivity
  ...
  MediaPlayer mp10,mp20,mp50,mp100,mp200,mp500,mp2000;
  ...
  public synchronized void onResume() {
    ...
    mp10 = MediaPlayer.create(this,R.raw.rs10);
    mp20 = MediaPlayer.create(this,R.raw.rs20);
    mp50 = MediaPlayer.create(this,R.raw.rs50);
    mp100 = MediaPlayer.create(this,R.raw.rs100);
    mp200 = MediaPlayer.create(this,R.raw.rs200);
    mp500 = MediaPlayer.create(this,R.raw.rs500);
    mp2000 = MediaPlayer.create(this,R.raw.rs2000);
        ...
        try {
          if (!five && recognitionTextView.getText().toString().equalsIgnoreCase("Rs. 500") && confi>99 ) {
            ...
            if(c500>5)
            {
              ...
              c500=0;c10=0;c20=0;c50=0;c100=0;c200=0;c2000=0;cfake=0;
            }
          ...
          else if(!nonote && recognitionTextView.getText().toString().equalsIgnoreCase("No Note Detected") && confi>99)
          {
            ten  =false;
            five =false;
            hun = false;
